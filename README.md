...
The main outputs from this stage are a set of polished primary contigs and associated haplotigs in fasta format:  **polished_p_ctgs.fasta** and **polished_h_ctgs.fasta**
